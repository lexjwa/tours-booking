...
class DayAfterDay extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'cron:day-afterday';
     ...
     * @var string
     */
    protected $description = 'At every second day of month';
    ...
    public function handle()
    {
        $user = DB::table('users')
            ...
            ->where('payment_reminders.day_after_day','=',1)
